//! CRC32 functions used for calculating checksums.

// This CRC32 function was converted to Rust for use with Ringhopper.
//
// Changes:
// - Adapted into Rust
// - CRC32 input and output are no longer negated (to match Halo's output)
